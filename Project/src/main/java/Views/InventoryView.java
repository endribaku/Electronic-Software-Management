...
public class InventoryView {
    ...
    ComboBox<Category> itemCategoryListView = new ComboBox<>(categories);
    ObservableList<Supplier> suppliers = FXCollections.observableArrayList();
    ComboBox<Supplier> itemSupplierListView = new ComboBox<>(suppliers);
    ...
    TextField itemPPriceField;
    TextField itemSPriceField;
    ...
    public InventoryView() {
        ...
        //Options ComboBox
        optionsComboBox.setStyle(LABEL_STYLE);
        ...
        addItemLabel.setStyle(BUTTON_STYLE);
        ...
        itemPPriceLabel.setStyle(LABEL_STYLE);
        ...
        itemSPriceLabel.setStyle(LABEL_STYLE);
        ...
        itemSupplierLabel.setStyle(LABEL_STYLE);
        addItemGrid.add(itemSupplierLabel, 0, 5);
        itemSupplierListView.setStyle(LABEL_STYLE);
        addItemGrid.add(itemSupplierListView, 1, 5);
        addItemButton.setStyle(LABEL_STYLE);
        ...
        addCategoryLabel.setStyle(BUTTON_STYLE);
        addCategoryHeader.setSpacing(160);
        editCategoryButton.setStyle(LABEL_STYLE);
        ...
        categoryNameLabel.setStyle(LABEL_STYLE);
        ...
        sectorCategoryLabel.setStyle(LABEL_STYLE);
        addCategoryGrid.add(sectorCategoryLabel, 0, 1);
        sectorComboBox.setStyle(LABEL_STYLE);
        addCategoryGrid.add(sectorComboBox, 1, 1);
        addCategoryButton.setStyle(LABEL_STYLE);
        ...
        addSectorLabel.setStyle(BUTTON_STYLE);
        editSectorButton.setStyle(LABEL_STYLE);
        ...
        editItemLabel.setStyle(BUTTON_STYLE);
        ...
        itemEditNameLabel.setStyle(LABEL_STYLE);
        ...
        editCategoryLabel.setStyle(BUTTON_STYLE);
        ...
        categoryEditNameLabel.setStyle(LABEL_STYLE);
        ...
        editSectorLabel.setStyle(BUTTON_STYLE);
        ...
        inventoryListLabel.setStyle(BUTTON_STYLE);
        ...
        inventoryTableView.setColumnResizePolicy(TableView.UNCONSTRAINED_RESIZE_POLICY);
        ...
        itemPPriceColumn.setCellValueFactory(new PropertyValueFactory<>("purchasePrice"));
        ...
        itemSPriceColumn.setCellValueFactory(new PropertyValueFactory<>("sellingPrice"));
        ...
        updateInventoryButton.setStyle(LABEL_STYLE);
