...
public class EmployeesListView {
    ...
    TextField employeeEditFullNameField = new TextField();
    TextField employeeEditUsernameField = new TextField();
    TextField employeeEditPasswordField = new TextField();
    DatePicker employeeEditDOBField = new DatePicker();
    TextField employeeEditEmailField = new TextField();
    TextField employeeEditPhoneNumberField = new TextField();
    TextField employeeEditSalaryField = new TextField();
    ComboBox<Access> accessLevelEditList= new ComboBox<Access>(accessLevels);
    ...
    public EmployeesListView() {
        ...
        sectorEditListView.setStyle("-fx-font: 11pt Helvetica;");
